...
export type AuthInput = {
  accessToken: AuthInput_accessToken;
};

export type AuthInput_accessToken = string;

/*,
 * Fragments from ./src/graphql/schema.graphql,
 */

/*,
 * Operations from ./src/graphql/schema.graphql,
 */
...
export type authenticate_variables = {
  input: authenticate_variables_input;
};

export type authenticate_variables_input = AuthInput;

export type authenticate_data = {
  authenticate: authenticate_data_authenticate;
};

export type authenticate_data_authenticate = {
  __typename?: "AuthResponse";
  token?: Nullable<authenticate_data_authenticate_token>;
};
